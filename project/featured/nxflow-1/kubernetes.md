---
description: aws eks의 동작을 원격으로 실행할 수 있는 환경을 보장합니다.
---

# Flask for k8s | Github

## Dockerfile

직접 작성하고 활용하고 있는 Dockerfile 입니다.
...
자세한 설명은 깃헙에 포함하고 있습니다.

{% embed url="https://github.com/batteryhob/flask-awseks-dockerfile.git" %}

```
$ git clone https://github.com/batteryhob/flask-awseks-dockerfile.git
```
